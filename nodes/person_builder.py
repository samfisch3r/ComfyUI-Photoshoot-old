...
PRESETS = {
    ...
    "complexion": [
        ...
        ("Golden-Glow", "with a radiant golden sun-drenched glow"),
    ...
    "figure": [
        ...
        ("Sportlich Kurvig", "fit and curvy figure"),
    ...
    "hairEffect": [  # streaks and gradients - after cut and base colour
        ...
        ("Malteserkreuz-Balayage", "with high-contrast honey-blonde and caramel hand-painted balayage"),
        ("Goldener Unterton", "with warm golden undertones"),
        ("Helle Strähnen", "with fine bright highlights"),
        ("Helle Strähne", "with a platinum blonde streak"),
    ],
    "lashes": [
    ...
    "skinFeatures": [  # Mehrfachauswahl (im Node je ein Toggle)
        ...
        ("Nasenring", "a nose ring piercing"),
    ],
    "nailLength": [
    ...
    "eyewear": [
        ...
        ("Nerd-Brille", "black square glasses"),
